...
class Credentials {
    ...
    public function render() {
        ...
        echo '<br /><br />';
        echo '<label for="tr4ker_full_token">' . __('Tr4ker Full Token', 'all-in-one-download-torr9') . '</label>';
        echo '<input type="password" id="tr4ker_full_token" name="tr4ker_full_token" placeholder="' . esc_attr( __( 'Tr4ker Full Token', 'all-in-one-download-torr9' ) ) . '" required value="' . esc_attr( Crypto::decrypt( get_option( 'alli1d_tr4ker_full_token', '' ) ) ) . '" />';
        echo '<br /><br />';
